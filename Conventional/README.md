...
We provide four binarized dummy data files named `SampleData_Binarized_Subject_i_Session_j.mat`, each of which contains 7 ROIs and 1000 time points.  i $=1,2$ [NM: Fix the dollar mark throughout please.] denotes the participants, and j $=1,2$ denotes the sessions.
